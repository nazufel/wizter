...
# file to hold Bazel workspace information

# load the http rules from the builtin bazel tools and name it http_archive
load("@bazel_tools//tools/build_defs/repo:http.bzl", "http_archive")

# use http_archive rule to grab remote rules for go
http_archive(
...
# use http_archive rule to grab remote rules for gazelle
http_archive(
    name = "bazel_gazelle",
...
# load the rules retrieved for go and gazelle
...
go_repository(
    name = "com_github_enescakir_emoji",
    importpath = "github.com/enescakir/emoji",
    sum = "h1:W+HsNql8swfCQFtioDGDHCHri8nudlK1n5p2rHCJoog=",
    version = "v1.0.0",
)
...
# initialize go tool chain and set go version
